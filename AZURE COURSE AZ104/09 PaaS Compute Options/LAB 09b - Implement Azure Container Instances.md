...
![Diagram of the tasks.](../_attachments/az104-lab09b-aci-architecture.png)
...
> [!note]
> While you wait, you may be interested in viewing the [code behind the sample application](https://github.com/Azure-Samples/aci-helloworld). To view the code, browse the \\app folder.
...
![Screenshot of the ACI overview page in the portal.](../_attachments/az104-lab09b-aci-overview.png)
